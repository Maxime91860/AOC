 ...
 *
 * Used for teaching purpose at Master MIHPS
 *
...
public class FluidSolver
{
    ...
    {
    fluid_mihps.c_velocitySolver(u, uOld, v, vOld, curl, d, visc, dt, n, size);
    }
    ...
    fluid_mihps.c_densitySolver(d, dOld, diff, u, v , dt, n, size);
    }
}
